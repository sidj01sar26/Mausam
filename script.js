...
const error = document.querySelector(".errorHai");
const notFound = document.querySelector(".errorHai");
const errorText = document.querySelector("[data-errorText]");
const errorImg = document.querySelector("[data-errorImg]");

// Initial Variables
let oldTab = userTab;
let API_KEY = "d080e32980bf4b1d5640785905f05d0d";
...
async function fetchSearchWeatherInfo(city) {
    ...
    try {
        ...
        if (data.cod === "404") {
            // City not found, set error message and image
            notFound.classList.add("active");
            errorText.innerText = "Please enter a valid city !";
            errorImg.classList.add("active");
        } else {
            // City found, render weather information
            userInfoContainer.classList.add("active");
            renderWeatherInfo(data);
        }
    } catch (err) {
